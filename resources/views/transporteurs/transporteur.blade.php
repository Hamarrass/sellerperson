  ...
  <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"
              ...
              <h1 class="h3 mb-0 text-gray-800"> Transporteur   </h1>
      <ol class="breadcrumb">
            ...
            <table class="table align-items-left table-flush" id="dataTable">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->lastname }}</td>
                    <td>{{ $item->phone }}</td>
                    <td>  <img  id='{{ $item->id }}' src="images/{{ $item->id }}_{{$item->firstname}}/{{$item->image}}" alt="" width="60" height="60"></td>
                </tr>
                @endforeach
  ...
  <a class="scroll-to-top rounded" href="#page-top">
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
     <div class="modal-content">
       ...
       <form   class="from-group" method="POST" action='{{route('transporteur.store')}}' enctype="multipart/form-data">
           ...
           @csrf
            <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="file" name="image" id="img" onchange="loadPreview(this);" class="form-control">
                    <img id="image" src="img/logo/logo.png" class="" width="300" height="200"/>
...
$("#country_id").change(function(){
    ...
    var url = "{{ route('transporteur.show', ":id") }}";
